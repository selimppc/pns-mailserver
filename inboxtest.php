...
<div style="height:49px; width:100%; background-color:#eeeeee;">
   		...
   		<div style="height:20px; width:80px; float:left; background: #1f5e9e ; color:#fff; text-align:center; margin-left:3px;"><div class="white"><a href="#">Unread (<? //echo $check->Unread 
   		?>
   		)
   		</a></div></div>
<div style="height:20px; width:175px;  color:#FFF; float:right;">
                	<div style="width:39px; height:100%; float:left; margin-right:3px; text-align:center; background-color:#1f5e9e;"><div class="white"><a href="inboxtest.php?p=1&total=<? echo $count ?>">Inbox</a></div></div>
        ...
        <div style="height:33px; width:770px; background:url(images/messagetopblue.png); color:#FFF; margin:0 auto;">
          ...
          <div style="margin-left:10px; padding-top:5px; float:left; margin-right:120px;">Data Received&nbsp;</div>
				...
				<table width='210'  border='0' cellpadding='' cellspacing='' style="float:right;">
                    ...
                    <tr>
						...
						<?php if($page == 1){?> 		
                        	<td width='40'>&lt;&lt;</td>
                         <? }else{?>
                         	<td width='40' class="table"><a href="inboxtest.php?p=1&total=<? echo $count ?>">&lt;&lt;</a></td>
                            
                         <?php }if($page == 1){?> 
                        	<td width='40' align="center">&lt;</td>
						<? }else{?> 
                        	<td width='40' align="center" class="table"><a href="inboxtest.php?p=<? echo $page-1 ?>&total=<? echo $total+15 ?>">&lt;</a></td>
                            <? }?>
							<td width='55' align="center" bgcolor="#FFFFFF" style="color:#000"><? echo $page ?></td>
						<?php if($i == 0){ ?>
							<td width='40' align="center" class="table">&gt;</td>
						<? }else{ ?>
                        	<td width='40' align="center" class="table"><a href="inboxtest.php?p=<? echo $page+1 ?>&total=<? echo $i ?>">&gt;</a></td>
						<?php }if($i == 0){ ?>
                        	<td width='40' align="center">&gt;&gt;</td>
						<? }else{ ?>
							<td width='40' align="center" class="table"><a href="inboxtest.php?p=<? echo $lastPage+1 ?>&total=<? echo $a ?>">&gt;&gt;</a></td>
                         <?  }?>	
                   	</tr>
                 </table>
        </div>
