...
<div style="height:20px; width:275px;  color:#FFF; float:right;">
        ...
        <div style="width:788px; height:718px; overflow:auto">
			...
			if(isset($_POST['submit']) && isset($_POST['submit']) == "Save")
			{
				...
				if(isset($fullName) && isset($user) && isset($password))
				{	
					...
					else
					{
						...
						$sqlCheck = mysql_query("SELECT userName FROM `registration` WHERE `userName` = '$user'");
						...
						{if($check >0)
							$err[] = "This Name is Already in database.";
						}
					}
				...
				{
					$sqlSave = mysql_query("INSERT INTO `registration` VALUES ('','$user','$fullName','$password')");
					if($sqlSave)
					{
						echo "<span style='font-family:Arial; font-weight:bold; margin:20px;'>";
        ...
        <tr>
        	<td style="font-size:18px; font-weight:bold;" align="right">User Name:&emsp;</td>
            <td><input type="text" name="user" id="user"  value="" size="50" /></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" name="password" id="password" value="" size="50" /></td>
        </tr>
        <tr>
        	<td></td>
