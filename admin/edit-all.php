...
<div style="height:20px; width:275px;  color:#FFF; float:right;">
        ...
        <div style="width:788px; height:718px; overflow:auto">
			...
			if(isset($_POST['submit']) && isset($_POST['submit']) == "Save")
			{
				...
				$sqlSave = mysql_query("UPDATE `registration` SET `fullName`='$fullName' WHERE `id` = '$id'");
				if($sqlSave)
				{
					...
					echo "</span>";
					print "<script>";
					print " self.location='show-all.php?p=1&total=0';"; // Comment this line if you don't want to redirect
					print "</script>";	
				}
				else 
					echo "Some Problem.....";
		...
		?>
        <form method="post" action="edit-all.php?id=<? echo $id ?>">
